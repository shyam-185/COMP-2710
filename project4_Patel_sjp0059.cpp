//Shyam Patel
//sjp0059
//project4_Patel_sjp0059.cpp
//To compile my code type "g++ project4_Patel_sjp0059.cpp" and hit enter
//run using ./a.out
//make sure test files are in same directory before testing
//I used the hints on the project files and lab file
//Dr.Li's lecture helped me
...
#else
	cout << "*** Welcome to Shyam's trivia quiz ***" << endl;
	triviaList game;
	int total;
	initializeList(game);
	addTrivia(game);
